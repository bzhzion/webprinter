...
if ($pwd !== '' && (!isset($_SESSION['index_auth']) || $_SESSION['index_auth'] !== true)) {
    ...
    if ($message === null && !isset($_FILES['file'])) {
        ...
        if (!$upload['ok']) {
            ...
            if (!@unlink($dest)) {
                error_log('WebPrinter: failed to delete tmp file ' . $dest);
            }
...
<main class="card">
    ...
    <footer>
        ...
        <?php endif; ?>
        <div class="footer-meta">WebPrinter - créé par Painteau · <a href="https://github.com/bzhzion/webprinter" target="_blank" rel="noopener noreferrer">Projet GitHub</a> · <a href="LICENSE" target="_blank" rel="noopener noreferrer">License</a></div>
    </footer>
</main>
